...
use bevy::{
    ...
    render::{
        mesh::shape::Cube,
        options::WgpuOptions,
        render_resource::{Extent3d, TextureDimension, TextureFormat, WgpuFeatures},
    },
};
use rand::prelude::*;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    App::default()
        ...
        .insert_resource(bevy::log::LogSettings {
            ...
            filter: "bevy_hanabi=debug,spawn=trace".to_string(),
        })
...
fn setup(
    ...
    let effect = effects.add(
        EffectAsset {
            ...
            capacity: 32768,
            spawner: Spawner::new(SpawnMode::Rate(Value::Single(500.))),
    ...
    commands
        .spawn()
        //.insert(image)
        .insert_bundle(ParticleEffectBundle::new(effect.clone()))
        .with_children(|p| {
