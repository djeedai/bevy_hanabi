...
- Render
  ...
  - [x] Camera support
    - [x] Render layers
    - [x] 2D cameras ([`Camera2d`](https://docs.rs/bevy/0.18.0/bevy/core_pipeline/core_2d/struct.Camera2d.html)) only
    - [x] 3D cameras ([`Camera3d`](https://docs.rs/bevy/0.18.0/bevy/core_pipeline/core_3d/struct.Camera3d.html)) only
...
|---|:-:|---|
| `2d` | ✔ | Enable rendering through 2D cameras ([`Camera2d`](https://docs.rs/bevy/0.18.0/bevy/core_pipeline/core_2d/struct.Camera2d.html)) |
| `3d` | ✔ | Enable rendering through 3D cameras ([`Camera3d`](https://docs.rs/bevy/0.18.0/bevy/core_pipeline/core_3d/struct.Camera3d.html)) |
