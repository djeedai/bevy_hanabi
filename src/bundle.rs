...
pub struct ParticleEffectBundle {
    ...
    /// Algorithmically-computed indication of whether an entity is marked
    /// visible in the hierarchy and should be extracted for rendering.
    ///
    /// If your effect uses [`SimulationCondition::Always`] then this component
    /// is not necessary and you can remove it (spawn components manually
    /// instead of using this bundle).
    ...
    /// for any camera in the world and should be extracted for rendering.
    ///
    /// If your effect uses [`SimulationCondition::Always`] then this component
    /// is not necessary and you can remove it (spawn components manually
    /// instead of using this bundle).
...
mod tests {
    ...
    #[test]
    fn bundle_new() {
        let handle = Handle::weak_from_u128(42);
