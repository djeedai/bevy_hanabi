...
macro_rules! impl_module_unary_math_func {
    ($name: ident, $T: ident) => {
        #[doc = concat!("Build an expression calling a function, and append it to the module.\n\nThis is a shortcut for [`unary(UnaryOperator::", stringify!($T), ", inner)`](crate::graph::expr::Module::unary).")]
        #[inline]
        pub fn $name(&mut self, inner: ExprHandle) -> ExprHandle {
            self.math_fn(MathFunction::$T, inner, None, None, None)
        }
    };
}

macro_rules! impl_module_binary_math_func {
    ($name: ident, $T: ident) => {
        #[doc = concat!("Build an expression calling a function, and append it to the module.\n\nThis is a shortcut for [`unary(UnaryOperator::", stringify!($T), ", inner)`](crate::graph::expr::Module::unary).")]
        #[inline]
        pub fn $name(&mut self, arg0: ExprHandle, arg1: ExprHandle) -> ExprHandle {
            self.math_fn(MathFunction::$T, arg0, Some(arg1), None, None)
        }
    };
}

macro_rules! impl_module_ternary_math_func {
    ($name: ident, $T: ident) => {
        #[doc = concat!("Build an expression calling a function, and append it to the module.\n\nThis is a shortcut for [`unary(UnaryOperator::", stringify!($T), ", inner)`](crate::graph::expr::Module::unary).")]
        #[inline]
        pub fn $name(&mut self, arg0: ExprHandle, arg1: ExprHandle, arg2: ExprHandle) -> ExprHandle {
            self.math_fn(MathFunction::$T, arg0, Some(arg1), Some(arg2), None)
        }
    };
}
...
impl Module {
    ...
    pub fn math_fn(
        ...
        func: MathFunction,
        arg0: ExprHandle,
        arg1: Option<ExprHandle>,
        arg2: Option<ExprHandle>,
        arg3: Option<ExprHandle>,
    ) -> ExprHandle {
    ...
    impl_module_unary_math_func!(abs, Abs);
    impl_module_unary_math_func!(acos, Acos);
    impl_module_unary_math_func!(acosh, Acosh);
    impl_module_unary_math_func!(all, All);
    impl_module_unary_math_func!(any, Any);
    impl_module_unary_math_func!(asin, Asin);
    impl_module_unary_math_func!(asinh, Asinh);
    impl_module_unary_math_func!(atan, Atan);
    impl_module_unary_math_func!(atan2, Atan2);
    impl_module_unary_math_func!(atanh, Atanh);
    impl_module_unary_math_func!(ceil, Ceil);
    impl_module_unary_math_func!(count_leading_zeros, CountLeadingZeros);
    impl_module_unary_math_func!(count_one_bits, CountOneBits);
    impl_module_unary_math_func!(count_trailing_zeros, CountTrailingZeros);
    impl_module_unary_math_func!(cos, Cos);
    impl_module_unary_math_func!(cosh, Cosh);
    impl_module_unary_math_func!(degrees, Degrees);
    impl_module_unary_math_func!(determinant, Determinant);
    impl_module_unary_math_func!(extract_bits, ExtractBits);
    impl_module_unary_math_func!(exp, Exp);
    impl_module_unary_math_func!(exp2, Exp2);
    impl_module_unary_math_func!(find_lsb, FindLsb);
    impl_module_unary_math_func!(find_msb, FindMsb);
    impl_module_unary_math_func!(floor, Floor);
    impl_module_unary_math_func!(fract, Fract);
    impl_module_unary_math_func!(inverse_sqrt, InverseSqrt);
    impl_module_unary_math_func!(length, Length);
    impl_module_unary_math_func!(log, Log);
    impl_module_unary_math_func!(log2, Log2);
    impl_module_unary_math_func!(normalize, Normalize);
    impl_module_unary_math_func!(pack2x16float, Pack2x16float);
    impl_module_unary_math_func!(pack2x16snorm, Pack2x16snorm);
    impl_module_unary_math_func!(pack2x16unorm, Pack2x16unorm);
    impl_module_unary_math_func!(pack4x8snorm, Pack4x8snorm);
    impl_module_unary_math_func!(pack4x8unorm, Pack4x8unorm);
    impl_module_unary_math_func!(pow, Pow);
    impl_module_unary_math_func!(radians, Radians);
    impl_module_unary_math_func!(reverse_bits, ReverseBits);
    impl_module_unary_math_func!(round, Round);
    impl_module_unary_math_func!(saturate, Saturate);
    impl_module_unary_math_func!(sign, Sign);
    impl_module_unary_math_func!(sin, Sin);
    impl_module_unary_math_func!(sinh, Sinh);
    impl_module_unary_math_func!(sqrt, Sqrt);
    impl_module_unary_math_func!(tan, Tan);
    impl_module_unary_math_func!(tanh, Tanh);
    impl_module_unary_math_func!(transpose, Transpose);
    impl_module_unary_math_func!(trunc, Trunc);
    impl_module_unary_math_func!(unpack2x16float, Unpack2x16float);
    impl_module_unary_math_func!(unpack2x16snorm, Unpack2x16snorm);
    impl_module_unary_math_func!(unpack2x16unorm, Unpack2x16unorm);
    impl_module_unary_math_func!(unpack4x8snorm, Unpack4x8snorm);
    impl_module_unary_math_func!(unpack4x8unorm, Unpack4x8unorm);

    impl_module_binary_math_func!(cross, Cross);
    impl_module_binary_math_func!(distance, Distance);
    impl_module_binary_math_func!(dot, Dot);
    impl_module_binary_math_func!(max, Max);
    impl_module_binary_math_func!(min, Min);
    impl_module_binary_math_func!(step, Step);
    impl_module_binary_math_func!(reflect, Reflect);

    impl_module_ternary_math_func!(clamp, Clamp);
    impl_module_ternary_math_func!(face_forward, FaceForward);
    impl_module_ternary_math_func!(fma, Fma);
    impl_module_ternary_math_func!(mix, Mix);
    impl_module_ternary_math_func!(smoothstep, SmoothStep);
    impl_module_ternary_math_func!(refract, Refract);
...
impl WriterExpr {
    ...
    fn unary_math_fn(self, func: MathFunction) -> Self {
        let expr = self
            .module
            .borrow_mut()
            .math_fn(func, self.expr, None, None, None);
        WriterExpr {
            expr,
            module: self.module,
        }
    ...
    fn binary_math_fn(self, func: MathFunction, arg1: Self) -> Self {
        ...
        let expr = self
            .module
            .borrow_mut()
            .math_fn(func, arg0, Some(arg1), None, None);
        WriterExpr {
            expr,
            module: self.module,
        }
    ...
    fn ternary_math_fn(self, func: MathFunction, arg1: Self, arg2: Self) -> Self {
        ...
        let expr = self
            .module
            .borrow_mut()
            .math_fn(func, arg0, Some(arg1), Some(arg2), None);
        WriterExpr {
            expr,
            module: self.module,
        }
